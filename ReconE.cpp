...
class ReconE {
 ...
 private:
  ReconE(const Recon& r);            // dummy copy constructor
 ...
 public: 
    ...
    o2::math_utils::Vector2D<double> traceForward(Polar3DVector dirCkov) const
    {
    ...
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    void trs2Lors(math_utils::Vector3D<double> dirCkov, double& thetaCer, double& phiCer) const
    {
    // Theta Cerenkov reconstruction
